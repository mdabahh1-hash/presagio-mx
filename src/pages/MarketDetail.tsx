      ...
      <div className="market-detail-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: 28, alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div className="anim-1 card" style={{ padding: '28px 30px 26px' }}>
            ...
            {/* Share */}
            {(() => {
              const url = `${window.location.origin}/#/mercado/${id}`
              ...
              return (
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 22, paddingTop: 18, borderTop: '1px solid var(--border-subtle)', flexWrap: 'wrap' }}>
                  ...
                  <a className="share-btn" href={`https://wa.me/?text=${encodeURIComponent(text + ' ' + url)}`} target="_blank" rel="noopener noreferrer" aria-label="Compartir en WhatsApp" style={iconBtn}>
                  ...
                  <a className="share-btn" href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(url)}`} target="_blank" rel="noopener noreferrer" aria-label="Compartir en X" style={iconBtn}>
