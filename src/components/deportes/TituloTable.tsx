...
export function TituloTable({ market, liga }: { market: Market; liga: string }) {
  ...
  return (
    <div className="card" style={{ padding: '16px 18px 14px', minWidth: 0 }}>
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 8, marginBottom: 4 }}>
        <h3 className="section-title">{t('deportes.titleProb', { league: liga })}</h3>
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        {rows.map((o, i) => (
          <div key={o.outcome_key} className="list-row" style={{ padding: '10px 0', gap: 12 }}>
            ...
            <span className="dep-bar" style={{ width: 120 }}>
