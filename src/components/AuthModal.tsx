        ...
        {step === 'verify' ? (
          ...
          <>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
              <a href={authApi.googleUrl(oauthNext())} aria-label={t('nav.continueGoogle')} className="btn btn-secondary" style={{ flex: 1, height: 48 }}>
              ...
              <a href={authApi.githubUrl(oauthNext())} aria-label={t('nav.continueGithub')} className="btn btn-secondary" style={{ flex: 1, height: 48 }}>
